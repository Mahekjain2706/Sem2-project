...
if(!isset($_SESSION['user_name']) && !isset($_SESSION['user_email']) ){
   header('location:thirdquiz.php');
}


error_reporting(0);
$conn = mysqli_connect('localhost','id19262624_root','4>x!2^~0$Sz0d-C}','id19262624_user_db');
$query = " SELECT * FROM quiz_data2 ORDER BY ID LIMIT 2,3 ";
$data  = mysqli_query($conn,$query);
$total = mysqli_num_rows($data);


// $conn2  = mysqli_connect('localhost','root','','flag');
$query2 = " SELECT * FROM flag_data2 WHERE number='third' && email='".$_SESSION['user_email']."'  ";
 ...
 console.log(bulvalue);
    ...
    function updateCountdown() {
        ...
        if (time == 0) {
           <?php 
           //----------
$update2 = "UPDATE `flag_data2` SET bool_value='1' WHERE number='third' && email='".$_SESSION['user_email']."'  ";
