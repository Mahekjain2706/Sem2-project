    ...
    <div id="mySidemenu" class="sidemenu">
        ...
        <div class="sm-wrapper">
            <a style="font-size:35px"
                href="https://webdproj2.000webhostapp.com/webdproj2/AJAY/student/firstpage.php"><i class="fas fa-home"
                    color="white"></i> Home</a>
            <a style="font-size:35px" href="https://webdproj2.000webhostapp.com/webdproj2/AJAY/student/quiz.php"><i
                    class="fas fa-qrcode" color="white"></i> Quiz's</a>
            <a style="font-size:35px" href="https://webdproj2.000webhostapp.com/webdproj2/AJAY/student/prof.php"><i
                    class="fas fa-address-card" color="white"></i> Profile</a>
            <a style="font-size:35px" class="nav-link"
                href="https://webdproj2.000webhostapp.com/webdproj2/AJAY/logout.php"><i class="fas fa-door-open"
